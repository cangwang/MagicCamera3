...
class PickPhotoView private constructor(private val builder: Builder) {
    ...
    class Builder(val activity: Activity) {
        ...
        /**
         * Set current chosen images size
         */
        ...
        fun setApplyButtonText(buttonText: String): Builder {
            PickConfig.applyButtonText = buttonText
            return this
        }
