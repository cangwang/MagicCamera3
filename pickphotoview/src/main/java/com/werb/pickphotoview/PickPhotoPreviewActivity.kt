...
class PickPhotoPreviewActivity : BasePickActivity() {
    ...
    private val allImages: List<MediaModel> by lazy { allImage() }
    ...
    private fun initToolbar() {
        GlobalData.model?.let {
            ...
            path?.let {
                val index = allImages.indexOfFirst { model -> model.path == it }
    ...
    private fun allImage(): List<MediaModel> {
    ...
    private inner class ListPageAdapter : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            pic.setImage(model, this@PickPhotoPreviewActivity::full)
