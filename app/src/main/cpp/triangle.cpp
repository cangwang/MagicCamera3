...
JNIEXPORT void JNICALL
Java_com_cangwang_magic_util_RenderJNI_glesResize(JNIEnv *env, jobject obj,jint width,jint height) {
    g_width=width;
    g_height=height;
}

JNIEXPORT void JNICALL
Java_com_cangwang_magic_util_RenderJNI_readShaderFile(JNIEnv *env, jobject obj,jobject assetManager) {
    if (assetManager && env){
