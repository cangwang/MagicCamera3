 ...
 * cangwang 2018.12.1
 */
MagicSunriseFilter::MagicSunriseFilter(){
...
void MagicSunriseFilter::onDrawArraysPre() {
    ...
    if(this->mMaskGery3TextureId !=0){
        glActiveTexture(GL_TEXTURE6);
        glEnable(GL_TEXTURE_2D);
        glBindTexture(GL_TEXTURE_2D,mMaskGery3TextureId);
        glUniform1i(mMaskGery3UniformLocation,6);

    }
}

void MagicSunriseFilter::onDrawArraysAfter() {
...
void MagicSunriseFilter::onInit() {
    ...
    mMaskGery3UniformLocation = glGetUniformLocation(mGLProgId,"grey3Frame");
}

void MagicSunriseFilter::onInitialized() {
    ...
    mMaskGery1TextureId=loadTextureFromAssets(mAssetManager,"amaro_mask1.jpg");
    mMaskGery2TextureId=loadTextureFromAssets(mAssetManager,"amaro_mask2.jpg");
    mMaskGery3TextureId=loadTextureFromAssets(mAssetManager,"toy_mask1.jpg");
}
