 ...
 * cangwang 2018.12.1
 */
MagicWhiteCatFilter::MagicWhiteCatFilter(){
...
void MagicWhiteCatFilter::onDestroy() {
    glDeleteTextures(1, &mToneCurveTexture);
}

void MagicWhiteCatFilter::onDrawArraysPre() {
...
void MagicWhiteCatFilter::onDrawArraysAfter() {
