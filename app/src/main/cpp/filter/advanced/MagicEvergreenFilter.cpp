 ...
 * cangwang 2018.12.1
 */
MagicEvergreenFilter::MagicEvergreenFilter(){

}

MagicEvergreenFilter::MagicEvergreenFilter(AAssetManager *assetManager)
...
void MagicEvergreenFilter::onDestroy() {
    glDeleteTextures(1,&mToneCurveTexture);
}

void MagicEvergreenFilter::onDrawArraysPre() {
...
void MagicEvergreenFilter::onDrawArraysAfter() {
    if (this->mToneCurveTexture != 0){
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D,mToneCurveTexture);
