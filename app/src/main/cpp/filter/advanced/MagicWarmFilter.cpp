 ...
 * cool滤镜
 */
MagicWarmFilter::MagicWarmFilter(){
...
void MagicWarmFilter::onDrawArraysAfter() {
...
void MagicWarmFilter::onInit() {
    GPUImageFilter::onInit();
    mToneCurveTextureUniformLocation = glGetUniformLocation(mGLProgId,"curve");
    mMaskGery1UniformLocation = glGetUniformLocation(mGLProgId,"layerImage");
    mMaskGery2UniformLocation = glGetUniformLocation(mGLProgId,"greyFrame");
}

void MagicWarmFilter::onInitialized() {
    ...
    for (int j = 0; j < 256; j++){
        ...
        arrayOfByte[(1 + (1024 + j * 4))] = arrayOfInt6[j];
        arrayOfByte[(2 + (1024 + j * 4))] = arrayOfInt7[j];
        arrayOfByte[(3 + (1024 + j * 4))] = arrayOfInt8[j];
    }

    glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,256,2,0,GL_RGBA,GL_UNSIGNED_BYTE,arrayOfByte);
    mMaskGery1TextureId=loadTextureFromAssets(mAssetManager,"warm_layer1.jpg");
    mMaskGery2TextureId=loadTextureFromAssets(mAssetManager,"bluevintage_mask1.jpg");
}
