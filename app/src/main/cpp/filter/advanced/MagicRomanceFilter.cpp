#include "MagicRomanceFilter.h"
#include "src/main/cpp/utils/OpenglUtils.h"

#define LOG_TAG "MagicRomanceFilter"
 ...
 * cool滤镜
 */
MagicRomanceFilter::MagicRomanceFilter(){
...
void MagicRomanceFilter::onDestroy() {
    glDeleteTextures(1,&mToneCurveTexture);
}

void MagicRomanceFilter::onDrawArraysPre() {
...
void MagicRomanceFilter::onDrawArraysAfter() {
    if (this->mToneCurveTexture != 0){
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D,mToneCurveTexture);
