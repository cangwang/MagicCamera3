#include "MagicNostalgiaFilter.h"
#include "src/main/cpp/utils/OpenglUtils.h"

#define LOG_TAG "MagicNostalgiaFilter"
 ...
 * cangwang 2018.12.1
 */
MagicNostalgiaFilter::MagicNostalgiaFilter(){
...
void MagicNostalgiaFilter::onDestroy() {
    glDeleteTextures(1,&mToneCurveTexture);
    glDeleteTextures(1,&mToneCurveTexture2);
}
...
void MagicNostalgiaFilter::onDrawArraysPre() {
    ...
    if(this->mToneCurveTexture2 !=0){
        glActiveTexture(GL_TEXTURE4);
        glEnable(GL_TEXTURE_2D);
        glBindTexture(GL_TEXTURE_2D,mToneCurveTexture2);
        glUniform1i(mToneCurveTextureUniformLocation2,4);
    }
    glUniform1f(mBlurSizeUniformLocation, 1.0F);
}

void MagicNostalgiaFilter::onDrawArraysAfter() {
    if (this->mToneCurveTexture != 0){
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D,mToneCurveTexture);
...
void MagicNostalgiaFilter::onInit() {
    GPUImageFilter::onInit();
    mToneCurveTextureUniformLocation = glGetUniformLocation(mGLProgId,"curve");
    mToneCurveTextureUniformLocation2 = glGetUniformLocation(mGLProgId, "curve2");
    ...
    mBlurSizeUniformLocation = glGetUniformLocation(mGLProgId, "blurSize");
}

void MagicNostalgiaFilter::onInitialized() {
