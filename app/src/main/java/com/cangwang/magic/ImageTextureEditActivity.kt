...
import com.cangwang.magic.view.ImageFilterTextureCallback
import com.werb.pickphotoview.model.SelectModel
import com.werb.pickphotoview.util.PickConfig
import kotlinx.android.synthetic.main.activity_album_texture.*
import kotlinx.android.synthetic.main.filter_layout.*

/**
 * 图片编辑
 */
class ImageTextureEditActivity: AppCompatActivity(){

    private var mAdapter: FilterAdapter? = null
    private var mSurfaceCallback: ImageFilterTextureCallback?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_album_texture)
        initView()
    }
    ...
    private fun initPreview(){
        ...
        mSurfaceCallback = ImageFilterTextureCallback(selectPaths.path)
        album_surfaceview.surfaceTextureListener = mSurfaceCallback
    }
