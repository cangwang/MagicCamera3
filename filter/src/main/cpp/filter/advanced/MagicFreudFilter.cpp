 ...
 * cangwang 2018.12.1
 */
MagicFreudFilter::MagicFreudFilter(){
...
void MagicFreudFilter::onDestroy() {
    glDeleteTextures(1,&mToneCurveTexture);
}

void MagicFreudFilter::onDrawArraysPre() {
...
void MagicFreudFilter::onDrawArraysAfter() {
    if (this->mToneCurveTexture != 0){
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D,mToneCurveTexture);
