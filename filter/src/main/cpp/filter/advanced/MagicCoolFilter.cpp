...
MagicCoolFilter::MagicCoolFilter(AAssetManager *assetManager)
    : GPUImageFilter(assetManager,readShaderFromAsset(assetManager,"nofilter_v.glsl"), readShaderFromAsset(assetManager,"cool.glsl")),mToneCurveTexture(-1){
