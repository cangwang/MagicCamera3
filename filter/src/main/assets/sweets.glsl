...
{ 
	vec4 color = texture(sampler, textureCoordinate) * 2.; 
	
	color -= texture(sampler, textureCoordinate-vec2(texelWidthOffset, 0. )) * 0.25;
	color -= texture(sampler, textureCoordinate+vec2(texelWidthOffset, 0. )) * 0.25; 
	color -= texture(sampler, textureCoordinate-vec2(0., texelHeightOffset)) * 0.25; 
	color -= texture(sampler, textureCoordinate+vec2(0., texelHeightOffset)) * 0.25; 
...
{ 
	...
	color += texture(sampler,textureCoordinate)* 0.0443 ; 
	
	step.x = 1.49583 * texelWidthOffset  * strength; 
	step.y = 1.49583 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+vec2(step.x, 0.)) * 0.04321; 
	color += texture(sampler,textureCoordinate-vec2(step.x, 0.)) * 0.04321; 
	color += texture(sampler,textureCoordinate+vec2(0., step.y)) * 0.04321; 
	color += texture(sampler,textureCoordinate-vec2(0., step.y)) * 0.04321; 
	
	step.x = 2.4719250988753685 * texelWidthOffset  * strength; 
	step.y = 2.4719250988753685 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+step) * 0.041795; 
	color += texture(sampler,textureCoordinate-step) * 0.041795; 
	color += texture(sampler,textureCoordinate+vec2(-step.x, step.y)) * 0.041795; 
	color += texture(sampler,textureCoordinate+vec2( step.x,-step.y)) * 0.041795; 
	
	step.x = 5.49583 * texelWidthOffset  * strength; 
	step.y = 5.49583 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+vec2(step.x, 0.)) * 0.040425; 
	color += texture(sampler,textureCoordinate-vec2(step.x, 0.)) * 0.040425; 
	color += texture(sampler,textureCoordinate+vec2(0., step.y)) * 0.040425; 
	color += texture(sampler,textureCoordinate-vec2(0., step.y)) * 0.040425; 

	step.x = 5.300352223621558 * texelWidthOffset  * strength; 
	step.y = 5.300352223621558 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+step) * 0.0391; 
	color += texture(sampler,textureCoordinate-step) * 0.0391; 
	color += texture(sampler,textureCoordinate+vec2(-step.x, step.y)) * 0.0391; 
	color += texture(sampler,textureCoordinate+vec2( step.x,-step.y)) * 0.0391; 

	step.x = 9.49583 * texelWidthOffset  * strength; 
	step.y = 9.49583 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+vec2(step.x, 0.)) * 0.037815; 
	color += texture(sampler,textureCoordinate-vec2(step.x, 0.)) * 0.037815; 
	color += texture(sampler,textureCoordinate+vec2(0., step.y)) * 0.037815; 
	color += texture(sampler,textureCoordinate-vec2(0., step.y)) * 0.037815; 
	
	step.x = 8.128779348367749 * texelWidthOffset  * strength; 
	step.y = 8.128779348367749 * texelHeightOffset * strength; 
	color += texture(sampler,textureCoordinate+step) * 0.03658; 
	color += texture(sampler,textureCoordinate-step) * 0.03658; 
	color += texture(sampler,textureCoordinate+vec2(-step.x, step.y)) * 0.03658; 
	color += texture(sampler,textureCoordinate+vec2( step.x,-step.y)) * 0.03658; 
...
{ 
	...
	if (lowPerformance == 1) 
	{ 	
		c1 = texture(inputImageTexture, textureCoordinate); 	
		c2 = texture(inputImageTexture, textureCoordinate); 
    } 
	else 
	{ 
